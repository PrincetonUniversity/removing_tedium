...
The shell function about is written in Bash. Below is `pycancel` which does exactly the same thing as `mycancel` except it is written in Python which is a language that most people prefer writing:
