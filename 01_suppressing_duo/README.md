...
Note that a [VPN](https://www.princeton.edu/vpn) is required to use the OnDemand web portals of MyAdroit and MyDella as well as for various library services such as downloading journal articles.
